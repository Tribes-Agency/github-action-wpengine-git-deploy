...
# Remove carriage return characters from the key files
tr -d '\r' < "$WPENGINE_SSH_KEY_PRIVATE_PATH" > "${WPENGINE_SSH_KEY_PRIVATE_PATH}_temp"
tr -d '\r' < "$WPENGINE_SSH_KEY_PUBLIC_PATH" > "${WPENGINE_SSH_KEY_PUBLIC_PATH}_temp"
mv "${WPENGINE_SSH_KEY_PRIVATE_PATH}_temp" "$WPENGINE_SSH_KEY_PRIVATE_PATH"
mv "${WPENGINE_SSH_KEY_PUBLIC_PATH}_temp" "$WPENGINE_SSH_KEY_PUBLIC_PATH"
